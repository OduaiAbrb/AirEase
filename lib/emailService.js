...
import { generatePackingRecommendations, generateTravelTips, calculateTimeBudget } from './geminiAI.js'
...
function generateEnhancedEmailContent(watchData, flightData, aiData) {
        ...
        <div class="content">
          <div class="flight-card">
            ...
            <div style="text-align: center; margin-top: 25px;">
              <a href="https://tripmonitor-2.preview.emergentagent.com/book/${flightData.id}" class="cta-button">
                🎫 Book Now - Limited Time!
              </a>
              <a href="https://tripmonitor-2.preview.emergentagent.com/watchlist" class="cta-button" style="background: linear-gradient(135deg, #6366f1, #4f46e5);">
                👀 Manage Watches
              </a>
            </div>
          </div>
  ...
  return {
    ...
    html: emailHTML,
    text: `Smart Flight Price Alert! Your watched flight ${flightData.from} → ${flightData.to} (${flightData.airline} ${flightData.flightNumber}) is now $${flightData.price}, hitting your target of $${watchData.targetPrice}. You saved $${watchData.targetPrice - flightData.price}! Includes AI packing recommendations and travel tips. Book now: https://tripmonitor-2.preview.emergentagent.com/book/${flightData.id}`
  }
}
